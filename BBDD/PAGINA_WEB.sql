...
DUENO_COMPRA INT NOT NULL,
CONSTRAINT PK_COMPRA PRIMARY KEY (ID),
CONSTRAINT FK_DUENO_COMPRA_PRODUCTOS FOREIGN KEY (DUENO_COMPRA) REFERENCES USUARIOS(ID) 
);
...
CONSTRAINT FK_ID_COMPRA_COMPRA FOREIGN KEY (ID_COMPRA) REFERENCES COMPRA(ID),
CONSTRAINT FK_ID_PRODUCTO_PRODUCTOS FOREIGN KEY (ID_PRODUCTO) REFERENCES PRODUCTOS(ID)
);